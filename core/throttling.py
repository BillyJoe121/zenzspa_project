"""
Clases de throttling (rate limiting) personalizadas.

Define límites de tasa específicos para diferentes tipos de endpoints
para proteger contra abuso y ataques de fuerza bruta.
"""
