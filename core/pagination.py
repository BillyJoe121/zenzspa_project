"""
Configuración de paginación para Django REST Framework.

Define clases de paginación reutilizables con formato de respuesta
estandarizado para mantener consistencia en toda la API.
"""
