...
class AboutPageViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        from core.serializers import AboutPageSerializer
    ...
    def update(self, request, pk=None):
        ...
        from core.models import AboutPage
        from core.serializers import AboutPageUpdateSerializer, AboutPageSerializer
...
class GalleryImageViewSet(viewsets.ModelViewSet):
    ...
    def get_serializer_class(self):
        from core.serializers import GalleryImageSerializer
