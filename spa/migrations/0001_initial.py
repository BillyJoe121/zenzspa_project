    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'Pendiente'), ('APPROVED', 'Aprobado'), ('DECLINED', 'Declinado'), ('ERROR', 'Error'), ('PAID_WITH_CREDIT', 'Pagado con Saldo a Favor')], default='PENDING', max_length=20)),
